...
| --------------------------------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Open-Meteo Air Quality API        | https://air-quality-api.open-meteo.com/v1/air-quality | O conjunto de reanálise de qualidade do ar CAMS Global possui dados desde agosto/2022 para pontos fora da Europa. O período utilizado no projeto é 31/08/2022 a 31/08/2026. | Horária            | Modelado — os dados de qualidade do ar são provenientes de modelos atmosféricos, não de uma estação de medição localizada exatamente no ponto do projeto. | Resolução espacial de aproximadamente 45 km para o CAMS Global fora da Europa; portanto, os valores representam uma grade/modelo atmosférico e não uma medição pontual da Universidade Braz Cubas.                                |
| Open-Meteo Historical Weather API | https://archive-api.open-meteo.com/v1/archive         | Disponibilidade histórica depende do conjunto selecionado. O ERA5 possui dados desde 1940; o período utilizado no projeto é 31/08/2022 a 31/08/2026.     | Horária            | Modelado/reanálise — os dados históricos são obtidos a partir de modelos e conjuntos de reanálise meteorológica.                                          | A resolução espacial depende do conjunto utilizado; para ERA5, a documentação informa aproximadamente 25 km. A escolha do período e do conjunto deverá considerar a compatibilidade com os dados de qualidade do ar. |
...
| Horizonte de previsão (deslocamento aplicado)                 | 1h à frente                                                                |
...
* A coleta de validação realizada na Sprint 1 contemplou o período de janeiro de 2025 (01/01/2025 a 31/01/2025) para testar o processo de coleta. O período oficial do projeto é 31/08/2022 a 31/08/2026, conforme definido no RFC.
